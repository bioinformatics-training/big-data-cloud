...
```{r createIAMuserCompletedForm, echo=FALSE, out.width='80%', fig.align='center', fig.cap="Create IAM user dialog. Auto generated policy replaced with manually edited version."}
knitr::include_graphics("images/create_iam_user_completed_form.png")
```
